        ...
        <div class="card" style="max-width: 700px; margin: 50px auto;">
            ...
            <form action="{{ route('admin.peserta.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="no_peserta" name="no_peserta" class="form-control" required>
                ...
                <div class="form-group">
                    <label>
                        <input type="checkbox" id="status_kirim_email" name="status_kirim_email" value="1">
                ...
                <div class="form-group">
                    <label>
                        <input type="checkbox" id="status_kirim_whatsapp" name="status_kirim_whatsapp" value="1">
